...
where os.status_id='ITEM_COMPLETED' AND pt.is_physical='Y' AND f.facility_type_id='WAREHOUSE' AND os.status_datetime>='2023-09-01 00:00:00.000' AND os.status_datetime<'2023-10-01';
